...
.data
	A: .word -5, -2, -3, -1, -4
	message1: .asciiz "Tong day con lon nhat: "
.text
main: 
	la $a0,A		# Dia chi cua A
	li $a1,5		# So phan tu cua A
	j mspfx
continue:
	la $a0, message1	
	li $v0, 4
	...
	li $v0, 1
	move $a0, $v1
	syscall			# In ra tong day con
	li $v0, 10
	syscall			# Ket thuc chuong trinh
end_of_main:
mspfx:
	addi $v0,$zero,0 	#initialize length in $v0 to 0
	addi $v1,$zero,-9999999	#initialize max sum in $v1to 0
